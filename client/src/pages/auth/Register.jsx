...
const Register = () => {
  ...
  const getPasswordStrengthText = (score) => {
    switch (score) {
      case 0:
      case 1:
        return { text: "อ่อนแอมาก", color: "bg-red-500", width: "w-1/4" };
      case 2:
        return { text: "ปานกลาง", color: "bg-yellow-500", width: "w-2/4" };
      case 3:
        return { text: "ดี", color: "bg-blue-500", width: "w-3/4" };
      case 4:
        return {
          text: "แข็งแกร่งมาก",
      ...
      default:
        return { text: "", color: "bg-slate-200", width: "w-0" };
    }
  };
